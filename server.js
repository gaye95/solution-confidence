...
// Fonction centrale pour gérer le paiement
...
// Routes utilisant la même fonction
app.post("/api/payment1", handlePayment);
app.post("/api/payment2", handlePayment);
app.post("/api/payment3", handlePayment);
